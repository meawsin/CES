...
class LoginPage(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # Styling for widgets (optional, but good for aesthetics)
        self.style = ttk.Style()
        self.style.configure("Login.TFrame", background="#ecf0f1", relief="raised", borderwidth=5)
        self.style.configure("TLabel", background="#ecf0f1", foreground="#34495e", font=("Arial", 12))
        self.style.configure("TEntry", font=("Arial", 12))
        self.style.configure("TButton", font=("Arial", 12, "bold"), background="#3498db", foreground="white")
        self.style.map("TButton", background=[('active', '#2980b9')])


        title_label = ttk.Label(login_frame, text="Admin Login", font=("Arial", 24, "bold"), background="#ecf0f1", foreground="#34495e")
